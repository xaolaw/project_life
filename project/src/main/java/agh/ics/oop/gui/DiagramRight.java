...
public class DiagramRight extends JPanel {
    ...
    public DiagramRight(MapSimulation2 simulation2, IEngine engine,int locationX,int locationY){
    ...
    public void paintComponent(Graphics g){
        ...
        g.drawString("[r] - Pause",15,this.getHeight()/2+300);
        g.drawString("[2] - save to csv in resources/files",15,this.getHeight()/2+350);
        //jungle
