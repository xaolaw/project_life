...
public class SimulationEngine implements IEngine{
    ...
    //co z animals?
    public SimulationEngine(int height,int width,int moveEnergy,int plantEnergy,double jungleRatio,int StartEnergy,int animalCount,boolean isCage){
        if (isCage){
            this.engineMap= new Cage(height,width,jungleRatio,StartEnergy,plantEnergy);
        }
        else{
